...
public sealed partial class Vertex : UserControl, INotifyPropertyChanged
{
    ...
    // Êîñòûëü ÷òîáû ïðåðûâàòü ïåðâîå ïåðåìåùåíèå âûçîâîì ñîáûòèÿ PointerMove
    ...
    private readonly Color DraggingColor = Color.Magenta;
    ...
    // CONSTRUCTORS
    public Vertex(Vector2 position, Constructor graph)
    {
    ...
    public void ConnectFromSelection()
    {
        ...
        Graph.RequestSelection(async (node, ephemeral) => {
            ...
            {
                await DialogHelper.ShowErrorDialogAsync("Ðåáðî óæå ñóùåñòâóåò", XamlRoot);
            }
            else
            {
